  ...
  useEffect(() => {
    fetch('/lessons.json')
      ...
      .then(data => {
        ...
        // Fallback: If lesson has no courseId, assume it belongs to the default 'class-12-ai' course
        const courseLessons = data.filter(l =>
          l.courseId === courseId || (!l.courseId && courseId === 'class-12-ai')
        )

        const enriched = courseLessons.map(lesson => ({
          ...lesson,
