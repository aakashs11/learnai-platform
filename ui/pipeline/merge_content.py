...
def merge_content():
    lessons_path = 'public/lessons.json'
    ...
    # 7. Copy Assets
    # We need to copy `pipeline/assets/handbook/*` to `public/assets/handbook/*`
    # The JSON refs are "assets/handbook/..." which corresponds to "public/assets/handbook/..."
